          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <Mail className="text-primary-400 mr-3" size={16} />
                <span className="text-gray-300">ecell@college.edu</span>
              </div>
              <div className="flex items-center">
                <Phone className="text-primary-400 mr-3" size={16} />
                <span className="text-gray-300">+1 (555) 123-4567</span>
              </div>
              <div className="flex items-center">
                <MapPin className="text-primary-400 mr-3" size={16} />
                <span className="text-gray-300">College Campus, Building A</span>
              </div>
            </div>
          </motion.div>
        </div>
